...
{
    public partial class Vibes : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["User"] != null || Session["Admin"] != null)
            {
                ...
                string show = "";
                dynamic getall = link.getbyType("Vehicles");
        ...
        protected void searchProduct(object sender, EventArgs e)
        {
            if (DropDownList1.SelectedValue.Equals("NearMe"))
            {
                ...
                if (suburb != null)
                {
                    ...
                    //  dynamic searchP = link.searchProduct("Vehicles",search.Value,suburb);
                    dynamic searchP = link.getbySuburb("Vehicles", suburb);
                    show += "<section class='products'>";
            ...
            else if (DropDownList1.SelectedValue.Equals("All"))
            {
                ...
                dynamic searchP = link.searchAllP("Vehicles", search.Value);
